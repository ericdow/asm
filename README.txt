...
The python module 'asm.py' can be used to perform dimensionality reduction using the active subspace method. An object representing the reduced dimension input space can be created using
